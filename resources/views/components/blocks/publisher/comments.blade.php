...
<section {{ $attributes->merge(['class' => 'bg-white dark:bg-gray-900 py-8 lg:py-16 antialiased']) }}>
    <div class="max-w-2xl mx-auto px-4">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-lg lg:text-2xl font-bold text-gray-900 dark:text-white">{{ $title }} ({{ $commentCount }})</h2>
        </div>
        ...
        <article class="p-6 text-base bg-white rounded-lg dark:bg-gray-900">
            <footer class="flex justify-between items-center mb-2">
                ...
                <button class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 dark:text-gray-400 bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-50 dark:bg-gray-900 dark:hover:bg-gray-700 dark:focus:ring-gray-600" type="button">
                    <x-fwb-o-dots-horizontal class="w-4 h-4" />
            ...
            <div class="flex items-center mt-4 space-x-4">
                <button type="button" class="flex items-center text-sm text-gray-500 hover:underline dark:text-gray-400 font-medium">
                    <x-fwb-o-message-caption class="mr-1.5 w-3.5 h-3.5" />
                    Reply
                </button>
            </div>
        </article>
        <article class="p-6 mb-3 ml-6 lg:ml-12 text-base bg-white rounded-lg dark:bg-gray-900">
            ...
            <p class="text-gray-500 dark:text-gray-400">Much appreciated! Glad you liked it.</p>
            <div class="flex items-center mt-4 space-x-4">
                <button type="button" class="flex items-center text-sm text-gray-500 hover:underline dark:text-gray-400 font-medium">
                    <x-fwb-o-message-caption class="mr-1.5 w-3.5 h-3.5" />
                    Reply
        ...
        <article class="p-6 mb-3 text-base bg-white border-t border-gray-200 dark:border-gray-700 rounded-lg dark:bg-gray-900">
            <footer class="flex justify-between items-center mb-2">
                <div class="flex items-center">
                    <p class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold">
            ...
            <p class="text-gray-500 dark:text-gray-400">The article covers the essentials, challenges, myths and stages the UX designer should consider while googling the key metrics of usability.</p>
            <div class="flex items-center mt-4 space-x-4">
                <button type="button" class="flex items-center text-sm text-gray-500 hover:underline dark:text-gray-400 font-medium">
                    <x-fwb-o-message-caption class="mr-1.5 w-3.5 h-3.5" />
                    Reply
